import {
    ...
    Button, Center, Flex, Heading, HStack, Input, InputGroup, InputRightElement, Table, TableContainer,
...
export default () => {
    ...
    const onClickDelete = async () => {
        ...
        console.log(lmid)
        let result = await axios.delete(`${url}/api/Manage/deleteManage/deleteLearnMa`, {
            headers: {
        ...
        <div className="">
            ...
            <Layout>
                <div className="p-4 mt-1">
                    <Heading size='2xl'>[Admin] Manage Learning Material</Heading>
                    <Box sx={line}></Box>
