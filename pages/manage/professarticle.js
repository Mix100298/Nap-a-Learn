import {
    ...
    Button, Center, Flex, Heading, HStack, Input, InputGroup, InputRightElement, Table, TableContainer, Tbody, Td, Th, Thead, Tr,
...
export default () => {
    ...
    const onClickDelete = async () => {
        ...
        console.log(paid)
        let result = await axios.delete(`${url}/api/Manage/deleteManage/deleteProArti`, {
            headers: {
                professarticleid: paid
            }
        })
        console.log(result)
        if (result) {
        ...
        <div className="">
            ...
            <Layout>
                <div className="p-4 mt-1">
                    <Heading size='2xl'>[Admin] Manage Professional Article</Heading>
                    <Box sx={line}></Box>
